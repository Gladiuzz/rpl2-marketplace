    ...
    <div class="ibox ">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                <a href="{{ route('user-pembeli.create') }}" class="border border-dark rounded bg-dark p-2">
                    ...
                    <tbody>
                        @foreach ($pembeli as $item)
                            <tr class="align-items-center">
                                ...
                                <td>
                                    <a href="{{ route('user-pembeli.show', ['user_pembeli' => $item->id]) }}"><i
                                            class='fa btn btn-primary fa-eye'></i></a>
                                    <a href="{{ route('user-pembeli.edit', ['user_pembeli' => $item->id]) }}"><i
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Are you sure want to delete {{ $item->nama }} ?
                            </div>
                            <form action="{{ route('user-pembeli.destroy', ['user_pembeli' => $item->id]) }}" method="post">
                                {{ csrf_field() }}
                                @method('DELETE')
